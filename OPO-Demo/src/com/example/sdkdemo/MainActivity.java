...
public class MainActivity extends Activity{
	...
	private String[] charges = new String[]{
			"Order","Begin","Completed","Failed","Buy","Use","RewardVirtual",
	...
	protected void onDestroy() {
    	...
    	bundle.putInt("action", CeltAgent.ACTION_START);
    	bundle.putString("package", "com.example.sdkdemo");
    	bundle.putString("activity", "MainActivity");
    	bundle.putString("ticker", "通知来了sdkdemo");
    	bundle.putString("title", "这是标题sdkdemo");
    	bundle.putString("text", "这是通知文本sdkdemo");
    	Log.d("CELTSER", "set Notification demo");
        mAgent.setNotification(2, bundle, 360);
    	mAgent.onExit();
		super.onDestroy();
	}	
